    ...
    <div class="mx-auto max-w-6xl px-4 py-10">
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
            <div class="card overflow-x-auto p-0">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a class="font-medium text-text-strong underline" href="/super-admin/organizations/<?= (int) $organization['id'] ?>"><?= htmlspecialchars((string) $organization['name']) ?></a></td>
            ...
            <div class="card">
                ...
                <h2 class="text-lg font-semibold text-text-strong">Select an organization</h2>
                <p class="mt-3 text-sm leading-6 text-text-muted">Choose an organization from the table to inspect its member list.</p>
                <?php else: ?>
                <h2 class="text-lg font-semibold text-text-strong"><?= htmlspecialchars((string) $selectedOrganization['name']) ?></h2>
                <p class="mt-1 text-sm text-text-muted">Slug: <?= htmlspecialchars((string) $selectedOrganization['slug']) ?></p>
                <div class="mt-5 overflow-x-auto rounded-xl border border-card-border">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Email</th>
